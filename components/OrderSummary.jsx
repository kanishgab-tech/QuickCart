...
const OrderSummary = () => {
  ...
  const { currency, router, getCartCount, getCartAmount, getToken, user, cartItems, setCartItems, getTaxAmount } = useAppContext()
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between">
            ...
            <p className="font-medium text-gray-800">{currency}{ getTaxAmount() }</p>
          </div>
          <div className="flex justify-between text-lg md:text-xl font-medium border-t pt-3">
            <p>Total</p>
            <p>{currency}{ getCartAmount() + getTaxAmount() }</p>
          </div>
        </div>
      </div>
